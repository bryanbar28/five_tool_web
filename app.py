...
st.markdown("""
_A behavioral operating system for high-performance environments. Designed to evaluate not just output, but behavior under pressure, natural tendencies, and the psychodynamic tensions that determine real-world effectiveness._
...
**Where It Shows Up:** Change management, customer-facing adaptation, executive communication in volatile contexts, ICs managing high-volume ambiguity
...
**Where It Shows Up:** Founders and team leads, accountable closers, high-pressure roles with final-call authority
...
**Where It Shows Up:** Compliance, audit, legal, ops, strategic planning, QA, IT architecture
...
**Where It Shows Up:** Ops, customer success, fulfillment, risk-sensitive execution roles
